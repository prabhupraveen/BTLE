...
// iverilog -o btle_rx_tb.vvp btle_rx_tb.v btle_rx.v btle_rx_core.v gfsk_demodulation.v symbol_timing_recovery_simple.v search_unique_bit_sequence.v scramble_core.v crc24_core.v serial_in_ram_out.v sdpram_two_clk.v rx_energy_detect_cca.v packet_timing_enforce.v packet_abort_on_crc_fail.v packet_abort_early_term.v
// vvp btle_rx_tb
...
reg [72*8:0] TEST_INPUT_I_FILENAME = "test_data/btle_rx_test_input_i.txt";
reg [72*8:0] TEST_INPUT_Q_FILENAME = "test_data/btle_rx_test_input_q.txt";
reg [72*8:0] TEST_OUTPUT_FILENAME  = "test_data/btle_rx_test_output.txt";
reg [72*8:0] TEST_OUTPUT_REF_FILENAME = "test_data/btle_rx_test_output_ref.txt";
reg [72*8:0] TEST_OUTPUT_CRC_OK_REF_FILENAME = "test_data/btle_rx_test_output_crc_ok_ref.txt";
