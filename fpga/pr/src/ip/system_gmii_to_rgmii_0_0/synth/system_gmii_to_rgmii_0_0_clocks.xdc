...
-objects  [get_clocks system_gmii_to_rgmii_0_0_rgmii_rx_clk] -objects [get_clocks -include_generated_clocks -of [get_ports rgmii_rxc]] -strings { "False Path" } -quiet
...
-objects [get_clocks system_gmii_to_rgmii_0_0_rgmii_tx_clk] -strings { "False Path" } -quiet
